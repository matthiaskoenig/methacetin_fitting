...
myfn <- funC0(c(bla = "((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60) / ((1 / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + ((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60))"))


pars_raw[getSymbols("((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60) / ((1 / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + ((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60))")]

do.call(myfn, as.list(pars_raw[getSymbols("((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60) / ((1 / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + ((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60))")]))
```
