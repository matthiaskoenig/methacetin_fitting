...
Combine all the data sets to ensure that all data sets share the same structure.
Then, redefine the original data to be a subset of the "whole" data set. This ensures that every data set has the same structure.
