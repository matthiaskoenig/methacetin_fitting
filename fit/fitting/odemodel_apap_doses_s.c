...
void odemodel_apap_doses_s_initmod(void (* odeparms)(int *, double *)) {
	 int N=197;
	 odeparms(&N, parms);
}

void odemodel_apap_doses_s_initforc(void (* odeforcs)(int *, double *)) {
	 int N=0;
	 odeforcs(&N, forc);
}

/** Derivatives (ODE system) **/
void odemodel_apap_doses_s_derivs (int *n, double *t, double *y, double *ydot, double *RPAR, int *IPAR) {
	 ...
	 ydot[0] = ((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(y[20]/(BW*FVlu)/Kplu_apap)*BP_apap-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(y[0]/(BW*FVar))-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(y[0]/(BW*FVar))-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(y[0]/(BW*FVar))-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(y[0]/(BW*FVar))-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(y[0]/(BW*FVar))-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(y[0]/(BW*FVar))-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp)*(y[0]/(BW*FVar));
 	 ...
 	 ydot[79] = (-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVar))+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp)*(1/(BW*FVar))))*(y[79])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVlu)/Kplu_apap)*BP_apap)*(y[85]);
 	 ydot[80] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVar)))*(y[79])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVbo)/Kpbo_apap)*BP_apap))*(y[80]);
 	 ydot[81] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVar)))*(y[79])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVgu)/Kpgu_apap)*BP_apap))*(y[81])+(Ka_apap/Mr_apap*F_apap)*(y[90])+y[38]/Mr_apap*F_apap;
 	 ydot[82] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVar)))*(y[79])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVhe)/Kphe_apap)*BP_apap))*(y[82]);
 	 ydot[83] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVar)))*(y[79])+(-(CLrenal_apap*(1/(BW*FVki)*fup_apap)+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVki)/Kpki_apap)*BP_apap))*(y[83]);
 	 ydot[84] = ((((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp)*(1/(BW*FVar)))*(y[79])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVgu)/Kpgu_apap)*BP_apap)*(y[81])+(-(((APAPD_HLM_CL/fumic_apap)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*(1/(BW*FVli)*fup_apap/((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap)-(y[17]/(BW*FVli))*fup_apap*(1/(BW*FVli)*fup_apap)/pow(((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap),2))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh*(1/(BW*FVli)/Kpli_apap)*BP_apap))*(y[84])+(((CYP1A2MET_CL/fumic_metc13)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*(1/(BW*FVli)*fup_metc13/((y[19]/(BW*FVli))*fup_metc13+CYP1A2MET_Km_met)-(y[19]/(BW*FVli))*fup_metc13*(1/(BW*FVli)*fup_metc13)/pow(((y[19]/(BW*FVli))*fup_metc13+CYP1A2MET_Km_met),2)))*(0)+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVsp)/Kpsp_apap)*BP_apap)*(y[87]);
 	 ydot[85] = (-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVlu)/Kplu_apap)*BP_apap))*(y[85])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVve)))*(y[89]);
 	 ydot[86] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*FVar)))*(y[79])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*(1-(FVbo+FVhe+FVgu+FVki+FVli+FVlu+FVsp+FVve+FVar+FVpl)))/Kpre_apap)*BP_apap))*(y[86]);
 	 ydot[87] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVar)))*(y[79])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVsp)/Kpsp_apap)*BP_apap))*(y[87]);
 	 ydot[88] = (CLrenal_apap*(1/(BW*FVki)*fup_apap))*(y[83]);
 	 ydot[89] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVbo)/Kpbo_apap)*BP_apap)*(y[80])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVhe)/Kphe_apap)*BP_apap)*(y[82])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVki)/Kpki_apap)*BP_apap)*(y[83])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh*(1/(BW*FVli)/Kpli_apap)*BP_apap)*(y[84])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*(1-(FVbo+FVhe+FVgu+FVki+FVli+FVlu+FVsp+FVve+FVar+FVpl)))/Kpre_apap)*BP_apap)*(y[86])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVve))))*(y[89])+((1.386/ti_apap)*3600/Mr_apap)*(0);
 	 ydot[90] = (-(Ka_apap/Mr_apap*F_apap*Mr_apap))*(y[90])+-(y[38]/Mr_apap*F_apap*Mr_apap);
 	 ...
 	 ydot[92] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVar)))*(y[91])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVbo)/Kpbo_apap)*BP_apap))*(y[92]);
 	 ydot[93] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVar)))*(y[91])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVgu)/Kpgu_apap)*BP_apap))*(y[93])+(Ka_apap/Mr_apap*F_apap)*(0);
 	 ydot[94] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVar)))*(y[91])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVhe)/Kphe_apap)*BP_apap))*(y[94]);
 	 ydot[95] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVar)))*(y[91])+(-(CLrenal_apap*(1/(BW*FVki)*fup_apap)+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVki)/Kpki_apap)*BP_apap))*(y[95]);
 	 ydot[96] = ((((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp)*(1/(BW*FVar)))*(y[91])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVgu)/Kpgu_apap)*BP_apap)*(y[93])+(-(((APAPD_HLM_CL/fumic_apap)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*(1/(BW*FVli)*fup_apap/((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap)-(y[17]/(BW*FVli))*fup_apap*(1/(BW*FVli)*fup_apap)/pow(((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap),2))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh*(1/(BW*FVli)/Kpli_apap)*BP_apap))*(y[96])+(((CYP1A2MET_CL/fumic_metc13)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*(1/(BW*FVli)*fup_metc13/((y[19]/(BW*FVli))*fup_metc13+CYP1A2MET_Km_met)-(y[19]/(BW*FVli))*fup_metc13*(1/(BW*FVli)*fup_metc13)/pow(((y[19]/(BW*FVli))*fup_metc13+CYP1A2MET_Km_met),2)))*(0)+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVsp)/Kpsp_apap)*BP_apap)*(y[99])+-(1/fumic_apap*MPPGL*(BW*FVli)*F_PAR*60/1000*((y[17]/(BW*FVli))*fup_apap/((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap)));
 	 ydot[97] = (-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVlu)/Kplu_apap)*BP_apap))*(y[97])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVve)))*(y[101]);
 	 ydot[98] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*FVar)))*(y[91])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*(1-(FVbo+FVhe+FVgu+FVki+FVli+FVlu+FVsp+FVve+FVar+FVpl)))/Kpre_apap)*BP_apap))*(y[98]);
 	 ydot[99] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVar)))*(y[91])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVsp)/Kpsp_apap)*BP_apap))*(y[99]);
 	 ydot[100] = (CLrenal_apap*(1/(BW*FVki)*fup_apap))*(y[95]);
 	 ydot[101] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVbo)/Kpbo_apap)*BP_apap)*(y[92])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVhe)/Kphe_apap)*BP_apap)*(y[94])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVki)/Kpki_apap)*BP_apap)*(y[95])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh*(1/(BW*FVli)/Kpli_apap)*BP_apap)*(y[96])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*(1-(FVbo+FVhe+FVgu+FVki+FVli+FVlu+FVsp+FVve+FVar+FVpl)))/Kpre_apap)*BP_apap)*(y[98])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVve))))*(y[101])+((1.386/ti_apap)*3600/Mr_apap)*(0);
 	 ydot[102] = (-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVar))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVar))+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp)*(1/(BW*FVar))))*(y[102])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVlu)/Kplu_apap)*BP_apap)*(y[108]);
 	 ydot[103] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVar)))*(y[102])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVbo)/Kpbo_apap)*BP_apap))*(y[103]);
 	 ydot[104] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVar)))*(y[102])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVgu)/Kpgu_apap)*BP_apap))*(y[104])+(Ka_apap/Mr_apap*F_apap)*(0);
 	 ydot[105] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVar)))*(y[102])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVhe)/Kphe_apap)*BP_apap))*(y[105]);
 	 ydot[106] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVar)))*(y[102])+(-(CLrenal_apap*(1/(BW*FVki)*fup_apap)+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVki)/Kpki_apap)*BP_apap))*(y[106]);
 	 ydot[107] = ((((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu-((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp)*(1/(BW*FVar)))*(y[102])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQgu*(1/(BW*FVgu)/Kpgu_apap)*BP_apap)*(y[104])+(-(((APAPD_HLM_CL/fumic_apap)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*(1/(BW*FVli)*fup_apap/((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap)-(y[17]/(BW*FVli))*fup_apap*(1/(BW*FVli)*fup_apap)/pow(((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap),2))+((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh*(1/(BW*FVli)/Kpli_apap)*BP_apap))*(y[107])+(((CYP1A2MET_CL/fumic_metc13)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*(1/(BW*FVli)*fup_metc13/((y[19]/(BW*FVli))*fup_metc13+CYP1A2MET_Km_met)-(y[19]/(BW*FVli))*fup_metc13*(1/(BW*FVli)*fup_metc13)/pow(((y[19]/(BW*FVli))*fup_metc13+CYP1A2MET_Km_met),2)))*(0)+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVsp)/Kpsp_apap)*BP_apap)*(y[110])+((APAPD_HLM_CL/fumic_apap)*MPPGL*(BW*FVli)*F_PAR*60/1000)*1*((y[17]/(BW*FVli))*fup_apap/pow(((y[17]/(BW*FVli))*fup_apap+APAPD_Km_apap),2));
 	 ydot[108] = (-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVlu)/Kplu_apap)*BP_apap))*(y[108])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVve)))*(y[112]);
 	 ydot[109] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*FVar)))*(y[102])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*(1-(FVbo+FVhe+FVgu+FVki+FVli+FVlu+FVsp+FVve+FVar+FVpl)))/Kpre_apap)*BP_apap))*(y[109]);
 	 ydot[110] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVar)))*(y[102])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQsp*(1/(BW*FVsp)/Kpsp_apap)*BP_apap))*(y[110]);
 	 ydot[111] = (CLrenal_apap*(1/(BW*FVki)*fup_apap))*(y[106]);
 	 ydot[112] = (((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQbo*(1/(BW*FVbo)/Kpbo_apap)*BP_apap)*(y[103])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQhe*(1/(BW*FVhe)/Kphe_apap)*BP_apap)*(y[105])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQki*(1/(BW*FVki)/Kpki_apap)*BP_apap)*(y[106])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQh*(1/(BW*FVli)/Kpli_apap)*BP_apap)*(y[107])+(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*(1-(FQbo+FQhe+FQgu+FQki+FQh+FQsp))*(1/(BW*(1-(FVbo+FVhe+FVgu+FVki+FVli+FVlu+FVsp+FVve+FVar+FVpl)))/Kpre_apap)*BP_apap)*(y[109])+(-(((BW*COBW+(HR-HRrest)*COHRI/60)/1000)*3600*FQlu*(1/(BW*FVve))))*(y[112])+((1.386/ti_apap)*3600/Mr_apap)*(0);

	 for(int i=  0 ; i <  195 ; ++i) RPAR[i] = 0;
}
