...
void odemodel_apap_initmod(void (* odeparms)(int *, double *)) {
	 int N=128;
	 odeparms(&N, parms);
}

void odemodel_apap_initforc(void (* odeforcs)(int *, double *)) {
	 int N=0;
	 odeforcs(&N, forc);
}

/** Derivatives (ODE system) **/
void odemodel_apap_derivs (int *n, double *t, double *y, double *ydot, double *RPAR, int *IPAR) {
