...
# fit_47_fine <- readDMod.frame("fit_47_fine.rds")
...
pdf(file = paste0("plots_",modelversion,".pdf"), width = 16, height = 9)
...
pdf(file = paste0("plots_individual_",modelversion,".pdf"), width = 16, height = 9)
