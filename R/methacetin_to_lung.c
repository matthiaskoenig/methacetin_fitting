...
void methacetin_to_lung_initmod(void (* odeparms)(int *, double *)) {
	 int N=153;
	 odeparms(&N, parms);
}

void methacetin_to_lung_initforc(void (* odeforcs)(int *, double *)) {
	 int N=0;
	 odeforcs(&N, forc);
}

/** Derivatives (ODE system) **/
void methacetin_to_lung_derivs (int *n, double *t, double *y, double *ydot, double *RPAR, int *IPAR) {
